...
@SuppressWarnings({"WeakerAccess", "RedundantIfStatement", "unused"})
public final class ObjectId implements Comparable<ObjectId>, Serializable {
    ...
    @Override
    public int compareTo(@NonNull final ObjectId other) {
    ...
    private static int createMachineIdentifier() {
        ...
        try {
            ...
            Log.w("ObjectId", "Failed to get machine identifier from network interface, using random number instead", t);
        }
    ...
    private static short createProcessIdentifier() {
        short processId;
        try {
            processId = (short) android.os.Process.myPid();
            Log.w("ObjectId", "Got process id: " + processId);
        }
        catch (Throwable t) {
            processId = (short) new SecureRandom().nextInt();
            Log.w("ObjectId", "Failed to get process identifier from JMX, using random number instead", t);
        }
